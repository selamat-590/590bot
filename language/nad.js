...
exports.noregis = () => {
	return`*「❗」BELUM TERDAFTAR「❗」*\n\nsilakan daftar ketik : @verify`
}

exports.baned = () => {
	return`*「❗」Maaf kak kamu telah di banned , hubungi owner:v*`
}
...
exports.bug = () => {
	return`*Masalah telah di laporkan ke owner Lexxy, laporan palsu/main2 tidak akan ditanggapi*`
}
...
exports.limitcount = (isPrem, limitCounts) => {
	return`
*「 LIMIT COUNT 」*
sisa limit anda : ${isPrem ? '99999' : `${limitCounts}`}
...
Ovo : 0822-7991-5237
Dana : 0822-7991-5237
Follow IG : https://instagram.com/ff.lexxy._?igshi
